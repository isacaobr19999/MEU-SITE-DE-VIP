...
export type DiscordNotificationEvent = "PAYMENT_APPROVED" | "DELIVERY_COMPLETED" | "DELIVERY_FAILED" | "LOGIN_SECURITY_ALERT" | "STORE_MAINTENANCE_STARTED" | "STORE_MAINTENANCE_ENDED" | "STORE_MAINTENANCE_TEST";
