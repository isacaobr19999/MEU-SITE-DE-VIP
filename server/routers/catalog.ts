import { z } from "zod";
import { getPublicProductBySlug, listProductServers, listPublicActivePromotions, listPublicCategories, listPublicProducts } from "../db/catalog";
...
export const catalogRouter = router({
  ...
  promotions: publicProcedure.query(() => listPublicActivePromotions()),
