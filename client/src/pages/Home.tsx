  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#07111d] text-slate-100 selection:bg-emerald-300 selection:text-slate-950">
      ...
      <main className="relative z-10">
	        <section className="store-hero container grid items-center gap-8 pb-20 pt-10 sm:gap-10 sm:pt-14 lg:grid-cols-[1.05fr_.95fr] lg:gap-16 lg:pb-28 lg:pt-24">
	          <div className="max-w-2xl">
	            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-emerald-300/20 bg-emerald-300/[.08] px-4 py-2 text-[10px] font-bold tracking-[.16em] text-emerald-100"><span className="h-1.5 w-1.5 rounded-full bg-emerald-300 shadow-[0_0_12px_currentColor]" /> RECOMPENSAS DO SERVIDOR</div>
	            <h1 className="font-display max-w-xl text-[2.55rem] font-extrabold leading-[1.01] text-white sm:text-6xl lg:text-7xl">Equipe seu próximo <span className="text-emerald-300">nível</span> de aventura.</h1>
	          ...
	          <div className="hero-voxel-stage surface-panel relative aspect-[1.35] overflow-hidden rounded-[1.6rem] p-3 sm:aspect-video sm:rounded-[2rem] sm:p-4">
