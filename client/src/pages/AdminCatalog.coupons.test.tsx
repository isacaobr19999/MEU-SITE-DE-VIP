...
describe("catálogo administrativo de cupons", () => {
  beforeEach(() => {
    ...
    mocks.coupons.mockReturnValue(query([{ id: 41, code: "TEMPO10", type: "PERCENTAGE", percentageBasisPoints: 1000, fixedDiscountCents: null, productIds: [], active: true, archivedAt: null, maxUses: 5, endsAt: "2099-08-31T18:00:00.000Z" }]));
